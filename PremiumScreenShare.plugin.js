  ...
  const config = {
    info: {
      ...
      authors: [
        {
          name: "ehte",
          discord_id: "1087975695197675550",
          github_username: "ehte89",
        },
      ],
      version: "1.0",
      description: "Make the screen sharing experience PREMIUM.",
      github: "github.com:ehte89/premiumscreenshare",
      github_raw:
        "github.com:ehte89/premiumscreenshare/PremiumScreenShare.plugin.js",
    },
    changelog: [
      {
        title: "v0.0.1",
